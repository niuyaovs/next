...
const invite = [
  {
    ...
    post_duty:
      '基于Android平台，负责Android手机应用客户端程序的开发和维护;协助主管进行项目管理和系统设计',
    post_require:
      '本科及以上学历，计算机相关专业优先;2年以上Android开发经验，深入理解Java语言，扎实的编码基础;熟练使用Git、Android',
...
const interview = [
  {
    interview_id: '410544b2-4001-4271-9855-fec4b6a6442c',
    interview_time: '2024-01-20 15:00',
    interview_location: '汇文楼520',
    interview_person_id: '13512630772',
    hr_id: '410544b2-4001-4271-9855-fec4b6a6442h',
    company_id: 'didichuxing001',
    company_name: '滴滴出行',
  }
];
